...
const AUDIO = [5.0, 5.0, 5.0, 5.0, 1.003, 5.0, 1.259, 1.003, 5.077];
...
const CAPTIONS = ["A verdade está aqui", "Quem é Deus?", "Planos de paz", "Renovação", "Eterno", "Escolha", "Futuro", "Amor", "Mais conteúdo em inema.club"];

// ---------- CONTEÚDO HTML POR CENA ----------
function scene1() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>GANCHO BOMBASTICO</div><h1 class='title' id='s1-title'>Você está preparado para a verdade?</h1><p class='lead' id='s1-sub'>A verdade está aqui</p></div><div class='right'><div class='pergaminho' id='s1-pergaminho'></div></div></div>`;
}
function scene2() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>A VERDADE OCULTA</div><h1 class='title' id='s2-title'>Deus não é o que você pensa</h1><p class='lead' id='s2-sub'>Quem é Deus?</p></div><div class='right'><div class='aguia' id='s2-aguia'></div></div></div>`;
}
function scene3() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>A PROVA DAS ESCRITURAS</div><h1 class='title' id='s3-title'>Jeremias 29:11</h1><p class='lead' id='s3-sub'>Planos de paz</p></div><div class='right'><div class='pergaminho-hebraico' id='s3-pergaminho'></div></div></div>`;
}
function scene4() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>O MISTÉRIO REVELADO</div><h1 class='title' id='s4-title'>Águias renascem</h1><p class='lead' id='s4-sub'>Renovação</p></div><div class='right'><div class='aguia-renasce' id='s4-aguia'></div></div></div>`;
}
function scene5() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>A TRANSFORMAÇÃO</div><h1 class='title' id='s5-title'>Vida eterna</h1><p class='lead' id='s5-sub'>Eterno</p></div><div class='right'><div class='pessoa-oracao' id='s5-pessoa'></div></div></div>`;
}
function scene6() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>O CONFRONTO</div><h1 class='title' id='s6-title'>Escuro ou luz?</h1><p class='lead' id='s6-sub'>Escolha</p></div><div class='right'><div class='floresta-escura' id='s6-floresta'></div></div></div>`;
}
function scene7() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>O TESTEMUNHO</div><h1 class='title' id='s7-title'>Futuro garantido</h1><p class='lead' id='s7-sub'>Futuro</p></div><div class='right'><div class='sol-nascente' id='s7-sol'></div></div></div>`;
}
function scene8() {
  return `<div class='grid2'><div class='left'><div class='eyebrow'>O CHAMADO</div><h1 class='title' id='s8-title'>Deus é amor</h1><p class='lead' id='s8-sub'>Amor</p></div><div class='right'><div class='cruz-brilhante' id='s8-cruz'></div></div></div>`;
}
...
function anim(i, t) {
  ...
  switch (i) {
    case 1:
      P(`tl.from('#s1-title', {y: 50, opacity: 0, duration: 0.6, ease: 'power3.out'}, at(0.2)); tl.from('#s1-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.3));`);
      break;
    case 2:
      P(`tl.from('#s2-title', {y: 40, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s2-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 3:
      P(`tl.from('#s3-title', {y: 30, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s3-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 4:
      P(`tl.from('#s4-title', {y: 40, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s4-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 5:
      P(`tl.from('#s5-title', {y: 30, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s5-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 6:
      P(`tl.from('#s6-title', {y: 40, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s6-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 7:
      P(`tl.from('#s7-title', {y: 30, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s7-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 8:
      P(`tl.from('#s8-title', {y: 40, opacity: 0, duration: 0.5}, at(0.1)); tl.from('#s8-sub', {y: 20, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
  ...
  <body class="${VERT ? "v" : ""}" style="">
    <div id="root" data-composition-id="main" data-start="0" data-duration="${TOTAL}" data-width="${W}" data-height="${H}">
      ...
      <div class="scene-bg" id="scene-bg-8"><video autoplay muted loop playsinline style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0;"><source src="assets/bg_scenes/bg_s8.mp4" type="video/mp4"></video><div style="position:absolute;inset:0;background:rgba(0,0,0,0.50);z-index:1;"></div></div></div>
        ...
        <div class="ghost" id="ghost" data-layout-ignore>QUERIA</div><div id="grain"></div>
      </div>
${scenesHTML}
${captionsHTML}
      <div id="progress"></div>
