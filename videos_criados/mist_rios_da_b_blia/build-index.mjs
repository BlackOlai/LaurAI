...
const AUDIO = [5.0, 1.792, 1.856, 1.749, 1.557, 1.792, 1.941, 1.877, 5.077];
...
const CAPTIONS = ["Segredo Revelado", "Plano Divino", "João 3:16", "Romanos 8:28", "Isaías 40:31", "Jeremias 29:11", "Força em Deus", "Vida Eterna", "Mais conteúdo em inema.club"];

// ---------- CONTEÚDO HTML POR CENA ----------
function scene1() {
  return `<div class='eyebrow'><span class='dot'></span>GANCHO BOMBSTICO</div><h1 class='title' id='s1-title'>Um segredo mudará sua vida para sempre! <span class='accent'>Segredo Revelado</span></h1><div class='grid2'><div class='left'><div class='pergaminho'></div></div><div class='right'><h2 class='kicker' id='s1-sub'>Segredo Revelado</h2></div></div>`;
}
function scene2() {
  return `<div class='eyebrow'>A VERDADE OCULTA</div><h1 class='title' id='s2-title'>Deus tem um plano para você! <span class='accent2'>Plano Divino</span></h1><div class='grid2'><div class='left'><div class='nuvens'></div></div><div class='right'><h2 class='kicker' id='s2-sub'>Plano Divino</h2></div></div>`;
}
function scene3() {
  return `<div class='eyebrow'>A PROVA DAS ESCRITURAS</div><h1 class='title' id='s3-title'>Deus deu seu Filho por você! <span class='accent'>João 3:16</span></h1><div class='grid2'><div class='left'><div class='cruz'></div></div><div class='right'><h2 class='kicker' id='s3-sub'>João 3:16</h2></div></div>`;
}
function scene4() {
  return `<div class='eyebrow'>O MISTÉRIO REVELADO</div><h1 class='title' id='s4-title'>Tudo concorre para o seu bem! <span class='accent2'>Romanos 8:28</span></h1><div class='grid2'><div class='left'><div class='rosas'></div></div><div class='right'><h2 class='kicker' id='s4-sub'>Romanos 8:28</h2></div></div>`;
}
function scene5() {
  return `<div class='eyebrow'>A TRANSFORMAÇÃO</div><h1 class='title' id='s5-title'>Você voará como águia! <span class='accent'>Isaías 40:31</span></h1><div class='grid2'><div class='left'><div class='aguia'></div></div><div class='right'><h2 class='kicker' id='s5-sub'>Isaías 40:31</h2></div></div>`;
}
function scene6() {
  return `<div class='eyebrow'>O CONFRONTO</div><h1 class='title' id='s6-title'>Deus tem um plano para você! <span class='accent2'>Jeremias 29:11</span></h1><div class='grid2'><div class='left'><div class='mao'></div></div><div class='right'><h2 class='kicker' id='s6-sub'>Jeremias 29:11</h2></div></div>`;
}
function scene7() {
  return `<div class='eyebrow'>O TESTEMUNHO</div><h1 class='title' id='s7-title'>Esperar em Deus é ter força! <span class='accent'>Força em Deus</span></h1><div class='grid2'><div class='left'><div class='oracao'></div></div><div class='right'><h2 class='kicker' id='s7-sub'>Força em Deus</h2></div></div>`;
}
function scene8() {
  return `<div class='eyebrow'>O CHAMADO</div><h1 class='title' id='s8-title'>Crente e recebe vida eterna! <span class='accent2'>Vida Eterna</span></h1><div class='grid2'><div class='left'><div class='porta'></div></div><div class='right'><h2 class='kicker' id='s8-sub'>Vida Eterna</h2></div></div>`;
}
...
function anim(i, t) {
  ...
  switch (i) {
    case 1:
      P(`tl.from('#s1-title', {y: 50, opacity: 0, duration: 0.6, ease: 'power3.out'}, at(0.2));`);
      break;
    case 2:
      P(`tl.from('#s2-title', {y: 40, opacity: 0, duration: 0.5}, at(0.1));`);
      break;
    case 3:
      P(`tl.from('#s3-title', {x: 100, opacity: 0, duration: 0.7, ease: 'power3.out'}, at(0.3));`);
      break;
    case 4:
      P(`tl.from('#s4-title', {y: 30, opacity: 0, duration: 0.4}, at(0.2));`);
      break;
    case 5:
      P(`tl.from('#s5-title', {x: 50, opacity: 0, duration: 0.6, ease: 'power3.out'}, at(0.1));`);
      break;
    case 6:
      P(`tl.from('#s6-title', {y: 20, opacity: 0, duration: 0.5}, at(0.3));`);
      break;
    case 7:
      P(`tl.from('#s7-title', {x: 70, opacity: 0, duration: 0.8, ease: 'power3.out'}, at(0.2));`);
      break;
    case 8:
      P(`tl.from('#s8-title', {y: 10, opacity: 0, duration: 0.4}, at(0.1));`);
      break;
  ...
  <body class="${VERT ? "v" : ""}" style="">
    <div id="root" data-composition-id="main" data-start="0" data-duration="${TOTAL}" data-width="${W}" data-height="${H}">
      ...
      <div class="scene-bg" id="scene-bg-8"><video autoplay muted loop playsinline style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0;"><source src="assets/bg_scenes/bg_s8.mp4" type="video/mp4"></video><div style="position:absolute;inset:0;background:rgba(0,0,0,0.50);z-index:1;"></div></div></div>
        ...
        <div class="ghost" id="ghost" data-layout-ignore>MISTRIOS</div><div id="grain"></div>
      </div>
${scenesHTML}
${captionsHTML}
      <div id="progress"></div>
