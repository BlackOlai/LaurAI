...
FETCH_FONTS_CODE = """// Baixa as .woff2 do Google Fonts e gera assets/fonts/fonts.css (@font-face local).
...
COMPOSITION_TEMPLATE_CODE = """import { writeFileSync, readFileSync } from "node:fs";
...
<html lang="pt-BR">
  <head>
    ...
    <style>
      ${FONT_CSS}
      :root{
        --bg:/*_VAR_BG_*/; --bg2:/*_VAR_BG2_*/; --bg3:/*_VAR_BG3_*/;
        --fg:/*_VAR_FG_*/; --muted:#748CAB; --accent:/*_VAR_ACCENT_*/; --accent2:/*_VAR_ACCENT2_*/; --code:#2EC4B6;
        --accent-rgb: /*_VAR_ACCENT_RGB_*/;
      }
  ...
  <body class="${VERT ? "v" : ""}" style="/*_BG_PHOTO_CSS_*/">
    <div id="root" data-composition-id="main" data-start="0" data-duration="${TOTAL}" data-width="${W}" data-height="${H}">
      <div class="bg-layer" data-layout-ignore>
        <div id="bg-media">/*_BG_VIDEO_TAG_*//*_SCENE_BG_HTML_*/</div>
        <div id="glow"></div><div id="glow2"></div><div id="grid"></div>
        <div class="ghost" id="ghost" data-layout-ignore>/*_GHOST_TEXT_*/</div><div id="grain"></div>
      </div>
${scenesHTML}
${captionsHTML}
      <div id="progress"></div>
